...
namespace FischlWorks
{
    ...
    public class csHomebrewIK : MonoBehaviour
    {
        ...
        {
            /* We start from the point where the ray hit */
            ...
            leftFootHeightOffset += _WorldHeightOffset;
            rightFootHeightOffset += _WorldHeightOffset;
        ...
        private void ApplyBodyIK()
        {
            ...
            LimitValueByRange(minFootHeight - transform.position.y, 0, crouchRange),
        ...
        private float LimitValueByRange(float value, float mid, float range)
        {
